...
// Crear variable booleanoMix0 cuyo valor sea la comparación booleana (booleano1
//  or booleano2) and (booleano1 or (not booleano1 and not booleano2)
...
// 2.Operadores
`);
// Crear variable valorDivisión cuyo valor sea la división de 17 entre 3 y que
//  solo muestre 2 decimales en el resultado
...
// Crea una variable A cuyo valor sea el número 9, después crea una variable B
//  cuyo valor sea un string con el número 9, desarrolla la lógica para que
//  cuando A == B muestre por consola “Son iguales”, ¿qué pasa si en vez de tener
//  A == B, comprobamos que A === B?

// Uso 'a' y 'b' en minúsculas.
const a = 9;
const b = '9';
...
//  se muestre por consola “Que bien voy con mi mochila” y si no muestre por
//  consola “Creo q no necesito una mochila”
...
const checkHolyday = diaFestivo => {
    ...
    diaFestivo ?
        ...
        console.log("‘Hoy trabajo’ (si no estoy en paro)");
};
...
// Crea una variable arrayBucle tipo array vacía, rellénala con números del 4 al
//  18 utilizando un bucle
const arrayBucle = [];
...
// Recorre la variable creada anteriormente arrayBucle ,suma todos sus elementos
//  y guárdalos en una variable de nombre resultado
const resultado = arrayBucle.reduce((n, i) => n+i);
console.log("resultado:", resultado);

// Dado el siguiente array, [‘Con’, ‘Sofia’, ‘aprendiendo’, ‘bucles’], recorrelo
//  utilizando el bucle “for of” y muestra por consola todos sus elementos, después
//  recórrelo utilizando el bucle “for in” mostrando también por consola todos sus
//  elementos
...
// Crea un programa el cual te pregunte por una nota del 0 al 10 y dependiendo
//  del número, te devuelva la siguiente clasificación.
...
// Crea una función resta que espere dos parámetros a y b y que devuelva la resta
//  de los mismos.
const resta = (a, b) => a - b;
console.log("resta(-5, -8):", resta(-5, -8));

// Crea la función duplicaNumero debe recibir un tipo number y devolver el doble
//  del valor recibido. Si la función no recibe un dato tipo number debe devolver
//  el string ‘Debo ser ejecutada con un número’
